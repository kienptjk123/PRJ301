...
public class ReminderController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<AppointmentDTO> appointments = dao.getAllAppoinmentScheduled(loginUser.getUserID());
            request.setAttribute("appointments", appointments);
        } catch (Exception e) {
            request.setAttribute("message", "Error at DASHBOARD CONTROLLER");
        } finally {
            request.getRequestDispatcher("sendReminder.jsp").forward(request, response);
        }
